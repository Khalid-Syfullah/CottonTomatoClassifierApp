...
public class PlantDiseaseClassifierActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_plant_disease_classifier);
        ...
        classText.setText("Load a Plant Image with signs of Target Spot, Yellow Leaf, Mosaic virus etc.");
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PlantDiseaseClassifierActivity.super.onBackPressed();
            }
        });
...
//            MappedByteBuffer tfliteModel = fileChannel.map(FileChannel.MapMode.READ_ONLY, startoffset, declaredLength);
            ...
            MappedByteBuffer tfliteModel = FileUtil.loadMappedFile(PlantDiseaseClassifierActivity.this,"plant_disease_classifier.tflite");
            Interpreter tflite = new Interpreter(tfliteModel, tfliteOptions);

            // Loads labels out from the label file.
            labels = FileUtil.loadLabels(PlantDiseaseClassifierActivity.this,"labels.txt");
